...
<body>
    ...
    <nav class="navbar"   style="background:black;">
        <div class="max-width">
            <div class="logo">
            <img src="logo.png" width=100></div>
            <ul class="menu">
                <li><a href="#home" class="menu-btn">Home</a></li>
                
                <li><a href="#services" class="menu-btn">Services</a></li>
                <li><a href="cars.php" class="menu-btn">Our Cars</a></li>
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">VS AutoPartner</div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="field">
                    <div class="control">
                        <input type="text" name="Name" id="Name" class="input is-full-width" maxlength="100"
                            data-validate-field="Name" placeholder="Your Name" required>
                    </div>
                </div>
                <div class="field">
                    <div class="control">
                        <input type="email" name="Email" id="Email" class="input is-full-width" maxlength="100"
                            data-validate-field="Email" placeholder="Your Email" required>
                    </div>
                </div>
                <div class="field">
                    <div class="control">
                        <textarea name="Message" id="Message" class="textarea" maxlength="3000" rows="5" 
                        data-validate-field="Message" placeholder="Your Message" required></textarea>
                    </div>
                </div>
                <div id="fcf-status" class="fcf-status"></div>
                <div class="field">
                    <div class="buttons">
                       <br> <br> <br>          <br> <br> <br>          <br> <br> <br> <button id="fcf-button" type="submit" class="button is-link is-medium">Send Message</button>
                    </div>
                </div>
            </form>
...
<script src="fcf-assets/js/fcf.just-validate.min.js"></script>
    ...
    <footer>
        <img src="logo.png"  width=70 align="center"><br><br>
        <span>Created By <a href="https://www.k9infotech.live">K9 InfoTech</a> | <span class="far fa-copyright"></span> 2022 All rights reserved.</span>
    </footer>
